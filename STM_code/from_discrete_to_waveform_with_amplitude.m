function f_pattern = from_discrete_to_waveform_with_amplitude(pattern, amplitude, tau_act, tau_prim, tt)

    %activation of single channels
    f_pattern = diag(amplitude)*single_exp(pattern, tau_act, tt);
    %primacy modulation
