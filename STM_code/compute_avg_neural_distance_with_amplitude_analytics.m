function [distance_glob, distance_rel, distance_stm] = compute_avg_neural_distance_with_amplitude_analytics(...
...
for i_mouse = 1:n_mouse %iterate over mice
    ...
    for i_conc_level = 1:n_conc_level %iterate over conc level
        ...
        parfor id_trial = 1:n_trials
            ...
            [dist_glob, dist_rel, dist_stm] = compute_neural_distance_with_amplitude_single_pair_analytics(pattern_1, pattern_2, dff_max_1, dff_max_2, align_mode,...
