function [dist_glob, dist_rel, dist_stm] = compute_neural_distance_single_pair_analytics(odor1, odor2, align_mode, tau_act, tau_prim, tau_glob, teta, beta_glob, beta_rel, beta_0)
...
%     C_odor1 = A_odor1.*exp(-t_norm_odor1/tau_prim + (odor_1 + t_min_odor1)/tau_act);
%     C_odor2 = A_odor2.*exp(-t_norm_odor2/tau_prim + (odor_2 + t_min_odor2)/tau_act);
